...
class VideoV4 extends Component {
    ...
    return <div className="ltn__slider-area ltn__slider-4 position-relative ltn__primary-bg">
			...
			<video autoPlay muted loop id="myVideo">
				<source src={publicUrl+"assets/media/video.mp4"} type="video/mp4" />
			</video>
					...
					<div className="col-lg-12 align-self-center">
						...
						<div className="slide-item-info-inner ltn__slide-animation">
							<h4 className="slide-sub-title white-color animated">
								...
								Office Building</h4>
							<h1 className="slide-title text-uppercase white-color animated ">Grow Your Business <br /> With Us</h1>
						</div>
						</div>
					</div>
					</div>
